...
public class ListSortTest01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("외부정렬 기준 클래스, 내림차순 정렬 후 : " + list);
		System.out.println();
...
// 외부 정렬기준 클래스는 Comparator인터페이스를 구현해서 작성해야 한다.
// Comparator 인터페이스를 구현하는 클래스는 compare()라는 메서드를 재정의 해서 
// 정렬기준을 설정한다.

class Desc implements Comparator<String>{
	
	// compare() 메서드의 매개변수는 2개이고 정수형 데이터의 반환한다.
